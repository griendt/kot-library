...
@section('card-detail')
    ...
    <ul>
        ...
        <li>
            ...
            <ul>
                <li>{!! res('health-bonus') !!}<mark>Health: </mark> 180 <span class="diff">(+?)</span></li>
                <li>{!! res('gold-bonus') !!}<mark>Gold Bonus: </mark> 39% <span class="diff">(+?)</span></li>
                <li>{!! res('steal-bonus') !!}<mark>Steal Bonus: </mark> 26% <span class="diff">(+?)</span></li>
                <li>{!! res('best-pick-bonus') !!}<mark>Best Pick Bonus: </mark> 11% <span class="diff">(+?)</span></li>
            </ul>
        </li>
        <li>
        ...
        <li>
            ...
            <ul>
                <li>{!! res('health-bonus') !!}<mark>Health: </mark> 190 <span class="diff">(+?)</span></li>
                <li>{!! res('gold-bonus') !!}<mark>Gold Bonus: </mark> 43% <span class="diff">(+?)</span></li>
                <li>{!! res('steal-bonus') !!}<mark>Steal Bonus: </mark> 32% <span class="diff">(+?)</span></li>
                <li>{!! res('best-pick-bonus') !!}<mark>Best Pick Bonus: </mark> 17% <span class="diff">(+?)</span></li>
            </ul>
        </li>
    </ul>
@overwrite
